...
class Iterable:
    def __init__(self, max_vectors, max_points):
        ...
        self.vectors = [self._generate_random_vector(
            max_points) for _ in range(max_vectors)]

    def _generate_random_vector(self, max_points):
...
# Example usage:
random_vectors = RandomVectors(max_vectors=5, max_points=10)
